...
| 035 | [Kamatera]() | ?? | Ongoing | Monthly | $ 9.02 | Used for running MongoDB. [Suspended](https://console.kamatera.com/servers/a4442423-3fb2-4556-a659-cf159ff2d772/overview?auxFilter=&datacenter=&filter=&from=&nItems=10&sortBy=name&tags=) TO DO: Check if Sliplane does not already cover running MongoDB, so this is superfluous and can be cancelled. |
| 036 | [Nabu Casa]() | ?? | Ongoing | Monthly | ~$ 7.95~ | CANCELLED: Used for access to Home Assistant, but now use TailScale instead; free |
